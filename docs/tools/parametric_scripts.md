---
title: parametric_scripts
---

<!-- Generated by theme/make-tool-pages.py — edit that, not this file. -->

<p class="dceasy-tool-page-mark-wrap"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="dceasy-tool-page-mark" role="img" aria-label="parametric_scripts"> <g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <rect x="3.5" y="3.5" width="17" height="17" rx="2"/> <path d="M9.17 3.5 V20.5 M14.83 3.5 V20.5 M3.5 9.17 H20.5 M3.5 14.83 H20.5" opacity=".3" stroke-width="1.5"/> <rect x="9.17" y="9.17" width="5.66" height="5.66" fill="currentColor" stroke="none" opacity=".55"/> </g> </svg></p>
...
parametric_scripts covers step 4. The full DCEasy pipeline:

<div class="dceasy-pipeline-figure">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 820 282"
       class="dceasy-pipeline" role="img" aria-label="DCEasy processing pipeline, with step 4 highlighted as parametric_scripts' scope"
